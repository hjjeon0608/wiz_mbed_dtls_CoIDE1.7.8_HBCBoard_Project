...
#define MBEDTLS_CONFIG_FILE "ssl_config.h"
/************************ ssl config *************************************/

/* System supports functions */
//#define MBEDTLS_CONFIG_FILE  "ssl_config.h"   //define ssl function setting documenation
...
//	#define MBEDTLS_SSL_CLI_C           //define using SSL client handshark supports function !!!
//#endif
//
//#if defined (AS_SSL_SERVER)
//    #define MBEDTLS_SSL_SRV_C           //define using SSL server handshark supports function
//#endif
...
#define MBEDTLS_DEBUG_DFL_MODE  2 //define testing information output format. Default setting: Show file name and line
